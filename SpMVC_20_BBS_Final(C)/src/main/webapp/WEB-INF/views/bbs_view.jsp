	...
	$(function(){
		...
		$(document).on('click', 'button', function(){
			...
			if(txt == '수정') {
				...
				.serialize() 함수를 사용해서 form에 담긴 데이터를 문자열화하고 query형식으로 변경해 ajax의 data에 담아 전송
				*/
				
				
				
				// input box에 입력한 데이터를 json 형태로 변경하기
				// 항목이 많을 경우 문제를 일으킬 수 있음
				var aData = {c_writer : $('#c_writer'), c_subject : $('#c_subject')}
	...
	<section class="container-fluid p-4">
		...
		<form method="POST" class="main">
			<div class="row p-4 bg-light">
				...
				<div class="col-2">
					<input name="c_writer" 
						class="form-control" id="c_writer" placeholder="작성자">
				</div>
				<div class="col-8">			
					<input id="c_subject" name="c_subject"
						class="form-control" placeholder="댓글을 입력하세요">
				</div>
				<div class="col-2  d-flex justify-content-center">
					<button type="submit" class="btn btn-success btn-cmt-save">저장</button>
				</div>
			</div>
		</form>
		<div class="p-2">
