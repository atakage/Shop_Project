...
public class EncMain {
	...
	public static void main(String[] args) {
		...
		/*
		 * 로컬컴퓨터에 설정된 환경변수들 목록을 가져와서 그 중에 BIZ.COM으로 등록된 값을 보여라
		 */
		...
		String encUserId = pbEnc.encrypt(userName);
		...
		String saveUserName = String.format("mysql.username=ENC(%s)", encUserId);
		...
		System.out.println("db.connection.properties 저        장            완          료");
