 ...
 * spring 프로젝트의 bean 등 설정 파일을 불러와 spring project 실행 환경과 동일하게 테스트를 수행할 수 있도록 설정
 * 
...
public class AddrServiceTest {
	...
	/*
	 * spring의 bean으로 설정된 AddrService를 가져와서 사용할 수 있도록 설정 일반적인 spring 프로젝트 실행 방법과 동일하게 설정
	 */
...
//	
	...
	public void test() {
		...
		/*
		 * 비교할 대상의 데잉터를 작성하고 return된 데이터와 비교를 해서 테스트를 수행
		 */
